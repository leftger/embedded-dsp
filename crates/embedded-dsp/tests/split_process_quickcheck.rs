use embedded_dsp::filtering::{
    Biquad, BiquadClamp, BiquadFixed, DirectForm1, DirectForm1NoiseShaped,
};
use embedded_dsp::pipeline::{Lanes, Pair, Process, Split, SplitProcess};
// `Dsm`/`XorShift32` live in their dedicated modules and are re-exported at the
// crate root; `filtering` no longer carries a duplicate copy of either.
#[cfg(feature = "bytemuck")]
use embedded_dsp::types::Complex;
use embedded_dsp::{Dsm, XorShift32};
